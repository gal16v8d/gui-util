...
public class JPaginateTable extends JTable {
    ...
    public void setListeners() {
        ...
        ActionListener alFirst =
                (ActionEvent e) -> {
                    currentPageIndex = 1;
                    initFilterAndButton(paginateSorter, itemsPerPage);
                };
        ActionListener alPrev =
                (ActionEvent e) -> {
                    currentPageIndex -= 1;
                    initFilterAndButton(paginateSorter, itemsPerPage);
                };
        ActionListener alNext =
                (ActionEvent e) -> {
                    currentPageIndex += 1;
                    initFilterAndButton(paginateSorter, itemsPerPage);
                };
        ActionListener alLast =
                (ActionEvent e) -> {
    ...
    public void initFilterAndButton(
            TableRowSorter<TableModel> paginateSorter, Integer itemsPerPage) {
    ...
    public void setComponentBounds(int x, int y, int width, int height) {
        ...
        tableFirst.setBounds(
                ((width / (BUTTON_FACTOR * 3))),
                (y + height + BUTTON_SPACE),
                BUTTON_WIDTH,
                BUTTON_HEIGHT);
        tablePrev.setBounds(
                ((width / (BUTTON_FACTOR * 3)) + (BUTTON_SPACE + BUTTON_WIDTH)),
                (y + height + BUTTON_SPACE),
                BUTTON_WIDTH,
                BUTTON_HEIGHT);
        field.setBounds(
                ((width / (BUTTON_FACTOR * 3)) + ((BUTTON_SPACE + BUTTON_WIDTH) * 2)),
                (y + height + BUTTON_SPACE),
                BUTTON_WIDTH,
                BUTTON_HEIGHT);
        fieldTop.setBounds(
                ((width / (BUTTON_FACTOR * 3)) + ((BUTTON_SPACE + BUTTON_WIDTH) * 3)),
                (y + height + BUTTON_SPACE),
                BUTTON_WIDTH,
                BUTTON_HEIGHT);
        tableNext.setBounds(
                ((width / (BUTTON_FACTOR * 3)) + ((BUTTON_SPACE + BUTTON_WIDTH) * 4)),
                (y + height + BUTTON_SPACE),
                BUTTON_WIDTH,
                BUTTON_HEIGHT);
        tableLast.setBounds(
                ((width / (BUTTON_FACTOR * 3)) + ((BUTTON_SPACE + BUTTON_WIDTH) * 5)),
                (y + height + BUTTON_SPACE),
                BUTTON_WIDTH,
                BUTTON_HEIGHT);
    }
